...
node bin/agent.mjs escalate "missing order" --location downtown</pre></div>
          ...
          <section class="section" id="tools">
            ...
            <div class="grid">
              ...
              <div class="card"><div class="tool-name">pleasure_pizza_create_voice_agent</div><h3>Voice-agent demo</h3><p>Shows four progress updates over 15–20 seconds and returns the assigned demo number +1 (385) 406-9108.</p><span class="badge">Demo flow</span></div>
